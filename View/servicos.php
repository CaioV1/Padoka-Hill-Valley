...
<html>
    <head>
        <title>
            Serviços - Padoka Hill Valley
        </title>
        <meta charset="utf-8">
        <link rel = "shortcut icon" href = "Imagens/icone.png">
        <link type="text/css" rel="stylesheet" href="CSS/style.css">
        <link type="text/css" rel="stylesheet" href="CSS/style_servicos.css">
        <script src="JQuery/jquery-3.3.1.js"></script>
        <script>

            $(document).ready(function(){

               $.post("../router.php", {pagina:"Serviços"}).done(function(dados){
    ...
    <body>
        <header>
            <div id = "header_holder">
                ...
                <nav>
                    ...
                    <div class = "item_nav" style = "width:125px;color:#e09900;">
                        Serviços
                    </div>
                    <a href="lojas.php">
                        <div class = "item_nav">
        ...
        <form name="frm_autenticao" method="post" action="servicos.php">
