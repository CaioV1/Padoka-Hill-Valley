...
<html>
    <head>
        <title>
            Lojas - Padoka Hill Valley
        </title>
        <meta charset="utf-8">
        <link rel = "shortcut icon" href = "Imagens/icone.png">
        <link type="text/css" rel="stylesheet" href="CSS/style.css">
        <link type="text/css" rel="stylesheet" href="CSS/style_lojas.css">
        <script src="JQuery/jquery-3.3.1.js"></script> 
        <script src="JavaScript/map_script.js"></script>
        <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBWiU75AX8h0VHKBJIV6q1Nm-Ev0B2PEDQ&callback=myMap"></script>
        <script>
            
            $(document).ready(function(){
                
               $.post("../router.php", {pagina:"Lojas"}).done(function(dados){
    ...
    <body>   
        ...
        <form name="frm_autenticao" method="post" action="lojas.php">
