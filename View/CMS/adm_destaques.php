...
<html>
    <head>
        ...
        <link type="text/css" rel="stylesheet" href="CSS/style_adm_destaques.css">
        <link rel = "shortcut icon" href = "Imagens/imagens_gerais/icon.png">
        <meta charset="utf-8">
        <script src="JQuery/jquery-3.3.1.js"></script>
        <script src="JavaScript/modal_script.js"></script>
        <script src="JavaScript/crud_destaque_script.js"></script>
    </head>
    <body>
        <header>
        ...
        <form name="frm_destaques" method="get" action="adm_destaques.php">
            <div id = "main">
                <div id = "main_content">
                    ...
                    <div id = "title">Gerenciamento de Destaques</div>
                    <button id = "button_register" type = "button" onclick="abrirModal('modal')">Cadastrar Destaque</button>
            ...
            <div id = "modal" class = "modal">
                <div class = "modal_content">
                    ...
                    <div class = "input_content" style="margin-top:5px;height:250px;">
                        ...
                        <textarea name="txt_info" id="txt_info"></textarea>
                    </div>
                    <div id = "button_save">
