...
<html>
    <head>
        ...
        <link type="text/css" rel="stylesheet" href="CSS/style_adm_subcategoria.css">
        <link rel = "shortcut icon" href = "Imagens/imagens_gerais/icon.png">
        <meta charset="utf-8">
        <script src="JQuery/jquery-3.3.1.js"></script>
        <script src="JavaScript/modal_script.js"></script>
        <script src="JavaScript/crud_subcategoria_script.js"></script>
    </head>
    <body>
        <header>
        ...
        <form name="frm_subcategorias" method="get" action="adm_subcategorias.php">
            <div id = "main">
                <div id = "main_content">
                    ...
                    <div id = "title">Gerenciamento de Subcategorias</div>
                    <button id = "button_register" type = "button" onclick="abrirModal('modal')">Cadastrar Subcategoria</button>
            ...
            <div id = "modal" class = "modal">
                <div class = "modal_content">
                    ...
                    <div class = "input_content" style="margin-top:5px;">
                        ...
                        <input type="text" name="txt_nome" id="txt_nome" placeholder="Digite o nome da subcategoria" class="input_register">
                    </div>
                    <div class = "input_content">
                        <div class = "input_title">
                            Categoria
                        </div>
                        <select class = "input_register" style="width:300px;" name = "slt_categoria" id="slt_categoria">
                        </select>
                    </div>
